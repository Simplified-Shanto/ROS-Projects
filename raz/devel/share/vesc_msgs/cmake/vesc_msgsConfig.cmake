...
if("TRUE" STREQUAL "TRUE")
  set(vesc_msgs_SOURCE_PREFIX /home/raz/raz/src/f1tenth_system/vesc/vesc_msgs)
  set(vesc_msgs_DEVEL_PREFIX /home/raz/raz/devel)
  ...
  set(vesc_msgs_INSTALL_PREFIX /home/raz/raz/install)
...
if(NOT "/home/raz/raz/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vesc_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/raz/raz/src/f1tenth_system/vesc/vesc_msgs/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(vesc_msgs_EXPORTED_TARGETS ${${vesc_msgs_dep}_EXPORTED_TARGETS})
endforeach()
